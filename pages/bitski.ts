...
export class BitskiConnector extends Connector<
  BitskiProviderShim,
  BitskiConnectorOptions
> {
  readonly id: string;
  ...
  async getChainId(): Promise<number> {
    ...
    const chainId = normalizeChainId(
      (await provider.request({ method: "eth_chainId" })) as number
    );
...
export const bitskiWallet = ({
  ...
  iconUrl:
    options.iconUrl ?? "https://cdn.bitskistatic.com/docs-web/bitskiWallet.svg",
